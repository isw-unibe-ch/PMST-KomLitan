Data set name: PMST Litan Kom

Data set developer(s): Susie Kanshouwa, Sandra Auderset, Antonia Pauly

Data sheet author(s): Susie Kanshouwa, Sandra Auderset

Others who contributed to this document: Mangte Raymond Kom, Mangte Graceboy Kom, Mangte Nealson Kom
...
This data set was created to investigate the dynamics of person marking in Litan Kom and other South-Central Trans-Himalayan languages.
...
For Litan, it is a version of the community orthography used by speakers.

**How many instances are there in total?**

* Number of inflected forms: 208
* Number of unique inflected forms: 75
...
|paradigm |variants_tag |analysis_tag |paradigm_tag |  n|
|:--------|:------------|:------------|:------------|--:|
|pron     |unspecified  |             |             |  7|
|fut.aff  |unspecified  |             |certain_fut  | 39|
|fut.aff  |unspecified  |             |             | 39|
|fut.neg  |dialect_var  |             |             |  1|
|fut.neg  |informal     |fusion       |             |  1|
|fut.neg  |informal     |             |             |  2|
|fut.neg  |unspecified  |             |             | 39|
|nfut.aff |unspecified  |             |             | 39|
|nfut.neg |formal       |             |             |  2|
|nfut.neg |informal     |fusion       |             |  2|
|nfut.neg |unspecified  |             |             | 37|
...
* Glottocode: komi1270
* Language variety description: This is a variety of Kom spoken in Litan village, located in Chandel district of Manipur in northeast India. The Glottocode refers to Kom in general, not specifically to the Litan variety.

**Does the data pertain to specific dialects, geographical locations, genre, etc?**

The data was collected from Litan village. There are six regional varieties in Kom: Mongtung variety, Sinamkom variety, Moirang variety, Mantak variety, Sagang variety, and Tonsen variety. Though Litan is geographically closer to Tonsen, it has similarities with Moirang Mantak. Therefore, Kom 2009 included Litan as part of the Mantak variety.
...
**Is the data set self-contained, or does it link to or otherwise rely on external resources (for example, websites, tweets, other datas ets)?**
...
Mangte Raymond Kom, Mangte Graceboy Kom, Mangte Nealson Kom: native speakers (language consultants)
...
The data was collected predominantly between January and April 2026.
