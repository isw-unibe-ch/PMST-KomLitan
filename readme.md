# Person Marking in South-Central Trans-Himalayan: Litan Kom

This PARALEX set contains person markers in Litan Kom, including inflected verbal forms and pronouns. It constitutes part of the PMST (Person Marking in South-Central Trans-Himalayan) database.
...
## Additional information specific to Litan Kom

* Tone: Tone is unmarked, as tonal analysis is still pending.
* Mapping between database paradigm labels and Litan descriptive labels based on Aimol 2007:
...
a) informal (fused) vs. formal (unfused): e.g., ni-Σ-mak-eng vs ni-Σ-ma-eng (1SG-2PL.NFN)
b) certain future vs. unspecified future: e.g., kin-ni-mu-sik vs kin-ni-mu-sik-ke (certain future) (1PLE-2PL.FA) 
